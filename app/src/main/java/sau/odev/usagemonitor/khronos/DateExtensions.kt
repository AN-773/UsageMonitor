...
fun Date.with(year: Int = -1, month: Int = -1, day: Int = -1, hour: Int = -1, minute: Int = -1, second: Int = -1, milliseconds: Int): Date {
    calendar.time = this
...
val Date.beginningOfYear: Date
    get() = with(month = 1, day = 1, hour = 0, minute = 0, second = 0, milliseconds = 0)

val Date.endOfYear: Date
    get() = with(month = 12, day = 31, hour = 23, minute = 59, second = 59, milliseconds = 999)

val Date.beginningOfMonth: Date
    get() = with(day = 1, hour = 0, minute = 0, second = 0, milliseconds = 0)
...
fun Date.endOfMonth(): Date {
    ...
    return with(day = lastDay, hour = 23, minute = 59, second = 59, milliseconds = 999)
}

val Date.beginningOfDay: Date
    get() = with(hour = 0, minute = 0, second = 0, milliseconds = 0)

val Date.endOfDay: Date
    get() = with(hour = 23, minute = 59, second = 59, milliseconds = 999)

val Date.beginningOfHour: Date
    get() = with(minute = 0, second = 0, milliseconds = 0)

val Date.endOfHour: Date
    get() = with(minute = 59, second = 59, milliseconds = 999)

val Date.beginningOfMinute: Date
    get() = with(second = 0, milliseconds = 0)

val Date.endOfMinute: Date
    get() = with(second = 59, milliseconds = 0)
